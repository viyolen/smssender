...
@section('CONTENT')
    ...
    <div class="content">
        <div class="container-fluid">
            <form method="post" action="{{route("email.lists.users.update.post",['group'=>$group,'id'=>$id])}}">
                <div class="row">

                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Güncelle</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Ad Soyad</label>
                                    <input type="text" class="form-control" value="{{$data->name_surname}}" name="name_surname">
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
