...
@section('CONTENT')
    ...
    <div class="content">
        <div class="container-fluid">
            <form method="post" action="{{route("email.lists.update.post",$id)}}">
                <div class="row">

                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h5 class="m-0">Grup Düzenle</h5>
                            </div>
                            <div class="card-body">
                                <div class="form-group">
                                    <label>Grup Adı</label>
                                    <input type="text" class="form-control" value="{{$data->group_name}}" name="group_name">
                                    {{csrf_field()}}
                                </div>
                            </div>
                        </div>
