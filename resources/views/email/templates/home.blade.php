...
@section('CONTENT')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Email Temaları</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Ana Sayfa</a></li>
                        <li class="breadcrumb-item active">Email Temaları</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 text-right"><a href="{{route("email.templates.add")}}" type="button"
                                ...
                                @foreach($data as $row)
                                    <tr>
                                        ...
                                        <td class="project-actions text-right">
                                            ...
                                            <a class="btn btn-info btn-sm" href="{{route("email.templates.update",$row->id)}}">
                                                <i class="fas fa-pencil-alt">
                                                </i>
                                                 Düzenle
                                            </a>
                                            <a class="btn btn-danger btn-sm" href="{{route("email.templates.delete",$row->id)}}">
