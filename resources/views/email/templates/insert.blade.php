...
@section('CONTENT')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Email Template Ekle</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <div class="content">
        <div class="container-fluid">
            <form method="post" action="{{route("email.templates.add.post")}}" >
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-primary card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <textarea id="editor1" class="form-control" name="html" style="height: 500px"></textarea>
                                </div>
                            </div>
                        </div>
